...
- **20 states have a comprehensive law in effect as of mid-2026** (CA, CO, CT, DE, FL, IN, IA, KY, MD, MN, MT, NE, NH, NJ, OR, RI, TN, TX, UT, VA); **24 are enacted** on that same convention, so four are signed-but-not-yet-live: **Oklahoma** (Mar 2026 → 1 Jan 2027), **Louisiana** (May 2026 → 1 Jan 2027), **Alabama** (Apr 2026 → 1 May 2027) and **Vermont** (Jun 2026 → 1 Jan 2028). **verify current count + which are live:** https://www.multistate.us/insider/2026/2/4/all-of-the-comprehensive-privacy-laws-that-take-effect-in-2026 and the IAPP tracker. Counts differ legitimately by convention: trackers that exclude **Florida** (very high revenue threshold) report **19 in effect / 23 enacted** instead. State _which_ convention you used, and note health-specific laws like Washington's My Health My Data are not counted as comprehensive by anyone.
- **Only three took effect in 2026** (Indiana, Kentucky, Rhode Island — all 1 Jan); nothing else comes online during 2026. The 2025 session produced **zero** new comprehensive laws, but 2026 produced four — the growth has moved from new states to **amendments** tightening existing ones (e.g. Connecticut lowering its applicability threshold and adding LLM-training disclosure, Oregon banning sale of precise geolocation and under-16 data, Montana lowering thresholds).
- **California's rules got teeth in 2026**: the CPPA (rebranded **CalPrivacy**) regulations on **ADMT, risk assessments and cybersecurity audits took effect 1 Jan 2026**, with staged downstream compliance dates — verify the specific deadline before promising one. Enforcement has shifted from notice-posting to whether opt-outs actually propagate to downstream recipients (GM/OnStar, $12.75M, May 2026 — the first data-minimization action).
